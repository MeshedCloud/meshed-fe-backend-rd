...
import {Version, VersionCount} from "@/services/deployment/version";
import {Warehouse} from "@/services/deployment/warehouse";


/** 获取项目版本列表 GET /api/iam/project/version/list/:projectKey */
export async function getProjectVersionList(projectKey: string, params: {}, options?: { [key: string]: any }) {
...
export async function getProjectVersionCount(projectKey: string, params: {}, options?: { [key: string]: any }) {
...
export async function getProjectWarehouseList(projectKey: string, params: {}, options?: { [key: string]: any }) {
