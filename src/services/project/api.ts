...
export async function deleteProject(id: number, options?: Record<string, any>) {
  if (id === undefined) {
    return undefined;
  }
...
export async function getProjectServiceDetails(projectKey: string, params: {}, options?: Record<string, any>) {
...
export async function getProjectServiceCount(projectKey: string, params: {}, options?: Record<string, any>) {
...
export async function getProjectServiceDomainSelect(projectKey: string, params: {}, options?: Record<string, any>) {
...
export async function getProjectModelCount(projectKey: string, params: {}, options?: Record<string, any>) {
...
export async function getProjectModelFieldSelect(projectKey: string, params: {}, options?: Record<string, any>) {
